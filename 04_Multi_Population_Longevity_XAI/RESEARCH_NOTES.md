...
## 17. Regulatory Capital & Tail Risk Analysis (Fig. 15)

### 17.1 Capital Requirements: Solvency II vs. SST
The stochastic output from the LSTM was utilized to quantify regulatory capital under two major frameworks: **Solvency II** (Value at Risk 99.5%) and the **Swiss Solvency Test** (Expected Shortfall 99.0%). 

| Country | Median e0 (2050) | SCR (VaR 99.5%) | SCR (ES 99.0%) | Risk Standard |
| :--- | :--- | :--- | :--- | :--- |
| **Switzerland** | 85.19 | +0.087 yrs | +0.089 yrs | SST |
| **W. Germany** | 84.29 | +0.100 yrs | +0.101 yrs | Solvency II |

### 17.2 Financial Implications
- **Capital Efficiency**: The SCR (Solvency Capital Requirement) values identified by the LSTM are significantly lower than those typically derived from classical Random Walk with Drift (RWD) models. This suggests that the neural network's ability to capture non-linear trends and filter historical noise reduces "model risk" uncertainty, potentially leading to optimized reserve requirements.
- **Tail Behavior**: As illustrated in Fig. 15, the longevity distribution for Switzerland is highly concentrated (leptokurtic). The minimal difference between the threshold-based VaR and the average-based Expected Shortfall indicates a relative absence of "fat tails" or explosive longevity shocks in the 2050 horizon under the current model architecture.
- **Regulatory Pivot**: These results provide a quantitative basis for proposing LSTM architectures as robust "Internal Models" for capital calculation. By demonstrating that deep learning can grounded projections in biological and historical reality, it addresses the transparency hurdles required by frameworks such as SST and Solvency II.
